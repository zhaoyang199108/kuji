...
<!-- 		  <input type="text" class="form-control" placeholder="category"> -->
		...
		<div class="input-group" style="margin-top:10px">
		 <span class="input-group-addon">图片名称</span>
		 	  <input type="text" class="form-control" id="images_nm" name="images_nm" >
		</div>
		<div class="input-group" style="margin-top:10px">
		 <span class="input-group-addon">上传附件</span>
		 <input type="file" style="width:170px"   align="center" id="images" name="ep_file" />
		</div>
		<div class="input-group" style="margin-top:10px">
		...
		<div class="input-group" style="margin-top:10px">
		 <span class="input-group-addon">上传附件</span>
		  <input type="file" style="width:170px"  id="images" name="ep_file" />
		</div>
		<div class="input-group" style="margin-top:10px">
