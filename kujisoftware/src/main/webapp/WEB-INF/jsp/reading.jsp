...
<body>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapseOne"> 28天训练 </a>
					</h4>
				</div>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<div class="btn-group-vertical" style="width: 200px;">
							<button href="#col-md-9" type="button" class="btn btn-default"
								style="outline: none;">5X5格</button>
	...
	<div class="col-md-9">
		<form role="form">
			...
			<div class="input-group" style="margin-top: 10px">
				<span class="input-group-addon">图&nbsp;&nbsp;&nbsp;片</span> <img
					src="img/logon.gif" style="width: 200px; hight: 100px"
					id="images_nm" name="images_nm">
			</div>
			<div class="input-group" style="margin-top: 10px">
			...
			<div class="input-group" style="margin-top: 10px">
				<span class="input-group-addon">题&nbsp;&nbsp;&nbsp;目</span> <input
					type="text" class="form-control" placeholder="title">
			</div>
			<div class="input-group" style="margin-top: 10px">
				<span class="input-group-addon">答案A</span> <input type="text"
					style="width: 620px; hight: 160px" placeholder="答案A">&nbsp;&nbsp;&nbsp;
				<span> 是否正确 </span> &nbsp; <select style="width: 40px; hight: 40px"
					id="type">
			...
			<div class="input-group" style="margin-top: 10px">
				<span class="input-group-addon">答案B</span> <input type="text"
					style="width: 620px; hight: 160px" placeholder="答案B">&nbsp;&nbsp;&nbsp;
				<span> 是否正确 </span> &nbsp; <select style="width: 40px; hight: 40px"
					id="type">
					<option value="是">是</option>
					<option value="否">否</option>
			...
			<div class="input-group"
				style="margin-top: 10px; padding-bottom: 20px; border-bottom: 1px solid black">
				<span class="input-group-addon">答案C</span> <input type="text"
					style="width: 620px; hight: 160px" placeholder="答案C">&nbsp;&nbsp;&nbsp;
				<span> 是否正确 </span> &nbsp; <select style="width: 40px; hight: 40px"
					id="type">
					<option value="是">是</option>
					<option value="否">否</option>
