...
<!-- background:url(img/beijing.jpg) no-repeat 10px center -->
	<div id="container" class="container" style="margin-top:10px;height:600px;background:url(img/1.png) no-repeat center">
		...
		<div class="form-group">
		    ...
		    <input type="text" class="form-control" id="loginId" placeholder="请输入名称">
		</div>
		<div class="form-group">
	...
	<form id = "form1" method="get" action="http://localhost:8080/kujisoftware/questionFive/upload">
 	<input type="file" style="width:170px"  name="ep_file" id="ep_file" />
 	<div style="width:100px;height:100px;background:#CCC" onclick="upload()"></div>
 	</form>
 	<script>
